...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    title: "LLM Intern",
    institution: "Lingsome, Shenzhen",
    type: "work",
    description: [
      "Designed multi-granularity RAG indexing and joint retrieval strategies to improve domain-data retrieval.",
      "Researched and adapted Microsoft GraphRAG to company-specific domain data, constructing domain knowledge graphs.",
      "Explored automated RAG evaluation, building prototypes for question generation and Ground Truth annotation.",
    ],
    tags: ["LLM", "RAG", "GraphRAG", "Knowledge Graph", "RAG Evaluation"],
  },
  {
...
const zhExperiences: Experience[] = [
  ...
  },
  {
    ...
    type: "工作",
    description: [
      "设计多粒度 RAG 索引与联合检索方案，提升领域数据检索效果。",
      "研究并适配 Microsoft GraphRAG，将其应用于公司领域数据，构建领域知识图谱。",
      "探索 RAG 自动评测方案，搭建问题生成与 Ground Truth 标注原型。",
    ],
    tags: ["LLM", "RAG", "GraphRAG", "知识图谱", "RAG 评测"],
  },
  {
    id: "visiting-researcher",
